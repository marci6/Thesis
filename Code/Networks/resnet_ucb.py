...
class BayesianResNet(nn.Module):
    ...
    def __init__(self, block, layers, args):
        ...
        self.conv1 = BayesianConv2D(ncha, 32, 7, args, stride=2, padding=3, use_bias=True)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                BayesianConv2D(self.inplanes, planes * block.expansion, 1, self.args, stride=stride, use_bias=True),
